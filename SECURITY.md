...
- **Port scan:** TCP connection attempts to each device, working slowly
  through common ports first, then 1-1024, then all 65,535, at 10 attempts a
  second by default. This is the part most likely to be flagged by an
  intrusion detection system. It can be limited to common ports, slowed down,
  or switched off under **Settings › Scanning & health**.
